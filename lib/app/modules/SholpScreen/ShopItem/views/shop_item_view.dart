        ...
        title: Row(
          ...
          children: [
            SizedBox(
              child: Flexible(
                child: Text(
                  "SHOPPING CART (3 ITEMS)", style: TextStyle(fontSize: 16),
                ...
                child: Row(
                  children: [
                    SizedBox(
                      ...
                      width: getMediaQueryHeight(context: context, value: 150),
                      child: Image(
                        image: AssetImage(
                          "assets/bed.jpg",
                        ),
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButton(
                            ...
                            items: shopItemController.items.map((selectedType) {
                      ...
                      SizedBox(
                        width: getMediaQueryWidth(context: context, value: 55),
                      ),
                      Row(
                        children: [
                          Text(
                          ...
                          SizedBox(
                            width:
                                getMediaQueryWidth(context: context, value: 5),
                          ),
                          Text(
